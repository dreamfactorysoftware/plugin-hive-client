...
class ThriftHiveClient extends \metastore\ThriftHiveMetastoreClient implements \ThriftHiveIf
{
    ...
    public function recv_execute()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_execute_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_fetchOne()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_fetchOne_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_fetchN()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_fetchN_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_fetchAll()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_fetchAll_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_getSchema()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_getSchema_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_getThriftSchema()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_getThriftSchema_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_getClusterStatus()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_getClusterStatus_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_getQueryPlan()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\ThriftHive_getQueryPlan_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
