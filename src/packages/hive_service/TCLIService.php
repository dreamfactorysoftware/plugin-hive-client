...
class TCLIServiceClient implements \TCLIServiceIf
{
    ...
    public function recv_OpenSession()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_OpenSession_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_CloseSession()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_CloseSession_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetInfo()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetInfo_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_ExecuteStatement()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_ExecuteStatement_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetTypeInfo()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetTypeInfo_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetCatalogs()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetCatalogs_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetSchemas()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetSchemas_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetTables()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetTables_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetTableTypes()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetTableTypes_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetColumns()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetColumns_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetFunctions()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetFunctions_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetOperationStatus()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetOperationStatus_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_CancelOperation()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_CancelOperation_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_CloseOperation()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_CloseOperation_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetResultSetMetadata()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetResultSetMetadata_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_GetDelegationToken()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_GetDelegationToken_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_CancelDelegationToken()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_CancelDelegationToken_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
    ...
    public function recv_RenewDelegationToken()
    {
        ...
        if ( $bin_accel )
        {
            $result = thrift_protocol_read_binary( $this->input_, '\TCLIService_RenewDelegationToken_result', $this->input_->isStrictRead() );
        }
        else
        {
            $rseqid = 0;
