...
interface ThriftHiveMetastoreIf extends \FacebookServiceIf {
  ...
  public function create_function(\metastore\MetastoreFunction $func);
  public function drop_function($dbName, $funcName);
  public function alter_function($dbName, $funcName, \metastore\MetastoreFunction $newFunc);
...
class ThriftHiveMetastoreClient extends \FacebookServiceClient implements \metastore\ThriftHiveMetastoreIf {
  ...
  public function send_create_function(\metastore\MetastoreFunction $func)
  {
  ...
  public function send_alter_function($dbName, $funcName, \metastore\MetastoreFunction $newFunc)
  {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'func',
          'type' => TType::STRUCT,
          'class' => '\metastore\MetastoreFunction',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->func = new \metastore\MetastoreFunction();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->newFunc = new \metastore\MetastoreFunction();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \metastore\MetastoreFunction();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
